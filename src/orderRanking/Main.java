...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < list1.size(); i++) {
            Ranking aux = new Ranking(list1.get(i), i + 1) {
            };
            ranking.add(aux);
        }
        System.out.println(ranking);
        List<Ranking> o = new ArrayList<Ranking>();
        o = ranking;
        Collections.sort(ranking);
        System.out.println(ranking);
        List<Study> teste = new ArrayList<Study>();
        for (int i=0; i<o.size();i++){
            teste.add(o.get(i).getStudy());
        }
        
        //teste.add(o.get(0).getStudy());
    ...
    public static List<Study> loadingOrder(List<Study> list1) {
